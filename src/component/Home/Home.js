...
const Home = () => {
  return (
    <div>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-amber-200">
        <div className="relative mb-6 sm:mx-auto md:mb-10 md:max-w-md lg:max-w-lg">
          <img
            ...
            src="https://www.shutterstock.com/image-photo/distance-learning-online-search-interface-600w-549877795.jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=3&amp;h=750&amp;w=1260"
            alt=""
            />
          <Link
            href="/"
        ...
        <div className="mb-16 md:mb-0 md:max-w-xl sm:mx-auto md:text-center">
          ...
          You can learn development from this  page.It has something to learn.
          </p>
